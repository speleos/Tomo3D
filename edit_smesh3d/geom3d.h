...
inline bool
RegularDomain3d::inXRange(double d) const
{
...
inline bool
RegularDomain3d::inYRange(double d) const
{
...
inline bool
RegularDomain3d::inDomain(const Point3d& p) const
{
...
class RegularBC3d : public RegularDomain3d {
  public:
    ...
    bool   inBoundary(const Point3d& p) const { return inDomain(p); }
